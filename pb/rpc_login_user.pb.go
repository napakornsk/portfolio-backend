...
func (x *LoginUserRes) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *LoginUserRes) GetAccessTokenExpiresAt() *timestamp.Timestamp {
	if x != nil {
...
func (x *LoginUserRes) GetRefreshTokenExpiresAt() *timestamp.Timestamp {
	if x != nil {
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0xbb, 0x02, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x45, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x42, 0x2c, 0x5a,
	0x2a, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x20, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_rpc_login_user_proto_depIdxs = []int32{
	2, // 0: pb.LoginUserRes.user:type_name -> pb.User
	3, // 1: pb.LoginUserRes.access_token_expires_at:type_name -> google.protobuf.Timestamp
	3, // 2: pb.LoginUserRes.refresh_token_expires_at:type_name -> google.protobuf.Timestamp
